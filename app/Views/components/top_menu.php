...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
        <!-- Navbar Search -->
        <!-- <li class="nav-item"> -->
            <!-- <a href="<?php echo base_url();?>/auth/logout" class="mr-2">Logout</a> -->
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <div class="dropdown-divider"></div>
                <a href="#" class="dropdown-item">
                    <i class="fas fa-book mr-2"></i> Jumlah Buku
                    <span class="float-right text-muted text-sm">4</span>
                </a>
                <div class="dropdown-divider"></div>
                <a href="#" class="dropdown-item">
                    <i class="fas fa-map-marker-alt mr-2"></i> Total Harga
                    <span class="float-right text-muted text-sm">Rp. 360.000</span>
                </a>
                <!-- <div class="dropdown-divider"></div> -->
                <!-- <a href="#" class="dropdown-item">
