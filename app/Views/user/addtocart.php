            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-sm-6">
                        ...
                        <div class="col-12">
                            <img src="<?= base_url('assets/dist/img/b2.jpg') ?>" class="product-image" alt="Product Image">
                        </div>
                        <div class="col-12 product-image-thumbs">
                            <div class="product-image-thumb active"><img src="<?= base_url('assets/dist/img/b3.jpg') ?>"
                                    alt="Product Image"></div>
                            <div class="product-image-thumb"><img src="<?= base_url('assets/dist/img/b1.jpg') ?>" alt="Product Image">
                            </div>
                            <div class="product-image-thumb"><img src="<?= base_url('assets/dist/img/b2.jpg') ?>" alt="Product Image">
                            </div>
                            <div class="product-image-thumb"><img src="<?= base_url('assets/dist/img/b3.jpg') ?>" alt="Product Image">
                            </div>
                            <div class="product-image-thumb"><img src="<?= base_url('assets/dist/img/b4.jpg') ?>" alt="Product Image">
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-6">
                        <h3 class="my-3">Buku Novel Lautan Bercerita by Laila S.Chudori</h3>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta fugiat recusandae fugit eaque ut ipsa 
                          labore itaque sequi neque cumque ratione cupiditate, nam consequatur, id error sed ad animi accusantium.
                        </p>
                        <hr>
